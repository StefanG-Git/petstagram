...
from petstagram.main.templates.forms import CreatePetForm, EditPetForm, DeletePetForm


def pet_action(request, form_class, success_url_name, instance, template_name):
